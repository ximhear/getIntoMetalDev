...
class GameScene: ObservableObject {
    ...
    func update() {
        ...
        if InputController.controller.keysPressed.contains(.keyW) {
            ...
            movement[1] -= 0.1
        } else if InputController.controller.keysPressed.contains(.keyH) {
            spinPlayer(angles: .init(x: 3.0, y: 0))
        } else if InputController.controller.keysPressed.contains(.keyL) {
            spinPlayer(angles: .init(x: -3.0, y: 0))
        } else if InputController.controller.keysPressed.contains(.keyJ) {
            spinPlayer(angles: .init(x: 0.0, y: 3))
        } else if InputController.controller.keysPressed.contains(.keyK) {
            spinPlayer(angles: .init(x: 0.0, y: -3))
        }

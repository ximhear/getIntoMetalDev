...
class Matrix44 {
    ...
    private static func create_from_x_rotation(theta: Float) -> float4x4 {
        return float4x4(
            [1, 0, 0, 0],
    ...
    private static func create_from_y_rotation(theta: Float) -> float4x4 {
        return float4x4(
    ...
    private static func create_from_z_rotation(theta: Float) -> float4x4 {
        return float4x4(
